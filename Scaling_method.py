...
def absorption_line(x, y, order):
    start = [0,0,0,6560,0,6257,0,5888,0,0,0,5268,5178,5168,0,4920.25,4837]
    end = [0,0,0,6566,0,6259,0,5892,0,0,0,5270.35,5188,5169.2,0,4922,4840.2]
...
line_center = [0,0,0,6562.7,0,6258,0,5889.95,0,0,0,5270.0,5183,0,0,4920.828,4838.56]
...
absorption_center = line_center[order]  # Approximate wavelength of the absorption line center
...
sunspot_hand_11 = [5269.665, 5269.765, 5270.264]
sun_hand_11 = [5269.800, 5269.910, 5270.072]
...
sunspot_hand_15 = [4920.622, 4921.059, 4921.143, 4920.568]
sun_hand_15 = [4920.706, 4920.961, 4921.040, 4920.620]
...
g_lande_1 = [1,1,1,1,1,3.3333,1,2,1,1,1,1.4,1,1,1,1.5,2.6667]
g_lande_2 = [1,1,1,1,1,3.3333,1,1.333,1,1,1,1.5,1,1,1,1.65,2.6667]
j_1 = [0,0,0,0,0,0,0,0.5,0,0,0,5,0,0,0,5]
j_2 = [0,0,0,0,0,0,0,1.5,0,0,0,4,0,0,0,4]
